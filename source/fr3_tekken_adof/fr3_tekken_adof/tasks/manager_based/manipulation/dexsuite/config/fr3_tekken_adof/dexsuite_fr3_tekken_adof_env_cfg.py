...
class Fr3TekkenAdofMixinCfg:
    ...
    def __post_init__(self: dexsuite.DexsuiteReorientEnvCfg):
        ...
        self.observations.proprio.hand_tips_state_b.params[
            "body_asset_cfg"
        ].body_names = ["base_link", ".*_Distal_Phalanx"]
        self.rewards.fingers_to_object.params["asset_cfg"] = SceneEntityCfg(
            "robot", body_names=["base_link", ".*_Distal_Phalanx"]
        )


@configclass
class DexsuiteFr3TekkenAdofReorientEnvCfg(
    Fr3TekkenAdofMixinCfg, dexsuite.DexsuiteReorientEnvCfg
):
    pass


@configclass
class DexsuiteFr3TekkenAdofReorientEnvCfg_PLAY(
    Fr3TekkenAdofMixinCfg, dexsuite.DexsuiteReorientEnvCfg_PLAY
):
    pass


@configclass
class DexsuiteFr3TekkenAdofLiftEnvCfg(
    Fr3TekkenAdofMixinCfg, dexsuite.DexsuiteLiftEnvCfg
):
    pass


@configclass
class DexsuiteFr3TekkenAdofLiftEnvCfg_PLAY(
    Fr3TekkenAdofMixinCfg, dexsuite.DexsuiteLiftEnvCfg_PLAY
):
    pass
